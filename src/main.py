...
def run_fold(
    ...
    """
    if mode == "train":
        return train_fold(fold_idx, train_cases, val_cases, test_cases, include_background=include_background)

    if mode == "test":
        return test_fold(fold_idx, train_cases, val_cases, test_cases)

    if mode == "all":
        train_fold(fold_idx, train_cases, val_cases, test_cases, include_background=include_background)
        cleanup_memory()
        return test_fold(fold_idx, train_cases, val_cases, test_cases)
